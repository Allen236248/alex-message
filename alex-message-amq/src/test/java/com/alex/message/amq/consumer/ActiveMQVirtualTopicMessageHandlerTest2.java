...
@Component
public class ActiveMQVirtualTopicMessageHandlerTest2 implements MessageHandler<String> {

    @Override
    public void handleMessage(String message) throws MessageException {
        System.out.println("ActiveMQ VirtualTopic MessageHandler A2 : " + message);
    }
