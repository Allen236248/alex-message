...
@Component
public class ActiveMQVirtualTopicMessageHandlerTest3 implements MessageHandler<String> {

    @Override
    public void handleMessage(String message) throws MessageException {
        System.out.println("ActiveMQ VirtualTopic MessageHandler B1 : " + message);
    }
